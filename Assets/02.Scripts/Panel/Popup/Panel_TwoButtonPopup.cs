...
public class Panel_TwoButtonPopup : Base_AnimationPopup
{
    /// <summary>
    ...
    protected override void Logic_Init_Base()
    {
        ...
        GameManager.Instance.Event.RegisterEvent<Data_Popup>(eEventType.SetTwoButtonPopup, ShowPopup);
    }
