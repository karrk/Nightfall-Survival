...
public class Panel_SelectSlotPopup : Base_AnimationPopup
{
    protected override void Logic_Init_Base()
    {
        base.Logic_Init_Base();

        GameManager.Instance.Event.RegisterEvent(eEventType.ActShowSelectSlotPopup_MainMenu, ShowPopup);
    }
    ...
    public void OnClickSlot(int m_index)
    {
        // TODO :: 임시
